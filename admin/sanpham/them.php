...
<form class="" method="POST" action="sanpham/xuly.php" enctype="multipart/form-data">
  <div class="from-row row"> <div class="form-group col-3"><label for="masv">Tên Sản Phẩm</label><input type="text" class="form-control" name="tensp"></div>
    <div class="form-group col-2"><label >Mã Danh Mục</label>   <select name="madm" class="form-control browser-default custom-select">
   ...
   <div class="form-group col-2"><label >Danh Mục</label>   <select name="mancc" class="form-control browser-default custom-select">
  ...
  <div class="form-group col-3"><label >Đơn Giá</label><input type="text" class="form-control" name="dongia" required></div>
  <div class="form-group col-2"><label >Số Lượng</label><input type="text" class="form-control" name="soluong" required></div></div>
   <div class="from-row row">
   <div class="form-group col-6"><label >Ảnh Nền</label> <input type="file" class="form-control" name="anhnen" required></div>
  <div class="form-group col-6"><label >Ảnh sản phẩm</label> <input type="file" class="form-control" name="anhsp[]" multiple required></div>
   </div>
<div class="from-row row">  <div class="form-group col-12"><label >Mô Tả</label><textarea class="form-control" name="mota" required></textarea> </div></div>
