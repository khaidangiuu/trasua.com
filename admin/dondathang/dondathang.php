<div class="row">
                        ...
                        <td><?php if( $row['TinhTrang']==='chưa duyệt') {?>
                            <label class="badge badge-danger">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">Đang chờ xử lý</font>
                                </font>
                            </label>
                            <?php }elseif ($row['TinhTrang']==='Đã duyệt') {?>
                            <label class="badge badge-warning">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">Đã duyệt</font>
                                </font>
                            </label>
                            <?php }elseif ($row['TinhTrang']==='hoàn thành') { ?>
                            <label class="badge badge-secondary">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">Hoàn thành</font>
                                </font>
                            </label>
                            <?php }elseif ($row['TinhTrang']==='Hủy Bỏ') { ?>
                            <label class="badge badge-dark">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">Hủy Bỏ</font>
                                </font>
                            </label>
                            <?php } ?>

                        </td>
                        <td><a class="nav-link text-info"
                                href="index.php?action=xldathang&view=ctdh&mahd=<?php echo $row['MaHD']; ?>">Detail </a>
                        </td>
                        <td><?php if($row['TinhTrang']==="chưa duyệt"){echo '<a class="text-info" href="dondathang/xuly.php?action=duyet&mahd='.$row['MaHD'].'" >Duyệt <i class="fas fa-check"></i> </a>';}?>
                        </td>
                        <td><?php if($row['TinhTrang']==="chưa duyệt"){ ?>
                            <a class="text-info"
                                href="dondathang/xuly.php?action=huy&mahd=<?php echo $row['MaHD']; ?>">Hủy<i
    ...
    <div class="row m-auto">
        ...
        <ul class="pagination justify-content-center">
            ...
            <li class="page-item">
                <a class="page-link "
                    href="index.php?action=xldathang&trang=<?php echo $x ?>&dk=<?php echo $dk2 ?>"><?php echo $x ;?></a>
            </li>
            <?php      }
						      } ?>
