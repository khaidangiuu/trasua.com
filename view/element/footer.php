    ...
    <div class="container">
        <div class="row row-pb-md">
            <div class="col-5 footer-col colorlib-widget ">
                <h2 class="text-white fs-2">Dũng MilkTea</h2>
                <p class="text-white fs-6 ">Ở đây chúng tôi không có trà sữa ngon nhất, nhưng chắc chắn ngon hơn người yêu cũ bạn</p>
                <p class="text-white fs-6 text mb-0"><i class="fa-solid fa-location-dot"></i>
                    Địa chỉ: Số nhà, Tên đường, Phường, TP Sơn La.</p>
                <p class="text-white fs-6 text mb-0"><i class="fa-solid fa-phone"></i>
                    Hotline: (+84) 123 456 789</p>
                <p class="text-white fs-6 text mb-0"><i class="fa-solid fa-envelope"></i>
                    Email: dungnt@gmail.com</p>
            ...
            <div class="col-3 footer-col colorlib-widget">
                ...
                <ul class="colorlib-footer-links">
                    <li><a href="#" class="text-white fs-7">Trà sữa</a></li>
                    <li><a href="#" class="text-white fs-7">Mỳ cay</a></li>
                    <li><a href="#" class="text-white fs-7">Cà phê</a></li>
                    <li><a href="#" class="text-white fs-7">Bánh & Snack</a></li>
                </ul>
                </p>
            </div>
